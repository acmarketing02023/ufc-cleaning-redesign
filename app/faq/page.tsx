  ...
  const faqs = [
    {
      ...
      answer: "We typically provide quotes within 2 hours during business hours. For urgent requests, call us directly at (214) 218-2921 and we can often provide an estimate over the phone immediately."
    },
    {
    ...
    },
    {
      ...
      answer: "Fill out our free quote form on our website, call us at (214) 218-2921, or text us. We'll confirm details and schedule your service at a convenient time."
    },
    {
      ...
      <section className="bg-primary-600 text-white py-16">
        <div className="section-container">
          ...
          <p className="text-lg text-white">
            Have questions? We've got answers. Can't find what you're looking for? Call us at (214) 218-2921.
          </p>
        </div>
      </section>
